...
int main(){
  ...
  totalInterest= (interest/months)*principal;
  ...
  std::cout<<"\nThe total interest paid is $"<<totalInterest<<" and the total amount you'll pay is $"<<months*monthly<<".\n";
  return 0;
}
